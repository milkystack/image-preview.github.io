...
document.body.innerHTML += "<div id='footer'> <div class='footer_content'>[stickerlink] <a href='" + params.get('link') + "'>" + params.get('link') + "</a></div></div>";
document.body.innerHTML += "<div id='footer'> <div class='footer_content'>[sherelink] <a href='" + params.get('shortlink') + "'>" + params.get('title') + "</a></div></div>";
