...
document.body.innerHTML += "<div id='footer'><div class='footer_content'>[len] " + urls.length + "</div><div class='footer_content'>[mode] waifu2x: " + params.get('waifu2x') + " bgc: " + params.get('bgc') + " anim: " + params.get('anim') + "</div></div>";
